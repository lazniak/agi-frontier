...
| T48 | v3 rank honestly: tied groups from overlapping 68 % rating intervals, evidence-weight bar per row, "community Elo only" label, Method paragraph with the evidence-per-cohort table (REDESIGN §12.9) | shared, web/ui | done | |
